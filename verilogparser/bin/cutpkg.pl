...
=head2 Encoding of steps to be used with -skip and -only options:
     ...
     6.       RC Gate sims               rcgate
     7.       DC Gate sims               dcgate
     8.       RC LEC                     rclec
     9.       DC LEC                     dclec
     10.      DC Formality               form
     11.      DC Lint                    lint
     12.      Cut Formal                 frun
     13.      fCheck                     fcheck
     14.      Package cuts               pkg
     15.      Post package sims          postsims
     16.      Post package lint          postvcslint
     17.      Post package check design  postdclint
