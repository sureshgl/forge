...
constraint -add ip_top_sva.*.assert_*_cpu_check
constraint -add ip_top_sva.*.assert_tdout*_check
constraint -add ip_top_sva.*.assert_qmem*_check
#constraint -add ip_top_sva.assert_fifo_*_check
constraint -show -all
assertion -add ip_top_sva.assert_sr_*_check
assertion -add ip_top_sva.assert_up_*_check
assertion -show -all
prove
