...
cutpoint -add $::env(IFV_HIER).core.data_out
...
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_data_fwd_check
...
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_datw_check
assertion -show -all
prove
