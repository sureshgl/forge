...
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_ndout_check
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_tdout_check
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_ddout_check
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_cnt_fwd_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_head_fwd_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_hnxt_fwd_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_next_fwd_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_tail_fwd_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_data_fwd_check
assertion -show -all
prove
