...
cutpoint -add $::env(IFV_HIER_2).core.dout_bit_err
cutpoint -add $::env(IFV_HIER_2).core.dout_bit_pos
cutpoint -add $::env(IFV_HIER).ip_top_sva.mem_serr
cutpoint -add $::env(IFV_HIER_2).ip_top_sva.mem_serr
cutpoint -add $::env(IFV_HIER_2).dout
cutpoint -add $::env(IFV_HIER_2).serr
