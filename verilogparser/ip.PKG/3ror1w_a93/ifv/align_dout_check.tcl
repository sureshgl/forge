...
#define engine dagger sword3 sword saber hammer
#define halo seq off
#define auto_dist_max 4
assertion -delete -all
constraint -delete -all
cutpoint -add $::env(IFV_HIER).ip_top_sva.dout_bit?_err
cutpoint -add $::env(IFV_HIER).ip_top_sva.dout_bit?_pos
cutpoint -add $::env(IFV_HIER).ip_top_sva.pmem_serr
cutpoint -add $::env(IFV_HIER).ip_top_sva.pmem_derr
cutpoint -show -all
...
constraint -add $::env(IFV_HIER).ip_top_sva.assume_pmem_*err_check
