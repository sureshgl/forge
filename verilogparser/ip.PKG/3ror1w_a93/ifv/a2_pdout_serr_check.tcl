...
cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit?_err
cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit?_pos
...
constraint -add $::env(IFV_HIER_2).ip_top_sva.assume_pmem_*err_check
