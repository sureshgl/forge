...
constraint -add $::env(IFV_HIER).ip_top_sva_2.assume_rd_port5_unused
...
constraint -add $::env(IFV_HIER).ip_top_sva_2.rrate_loop.pb_l*.bb_l*.assume_read_rate
constraint -add $::env(IFV_HIER).ip_top_sva_2.wrate_loop.pa_l*.ba_l*.assume_write_rate
constraint -show -all
assertion  -add $::env(IFV_HIER).ip_top_sva.lp_ctrl.bank*.assert_t1_ctrl_return_loop
assertion  -add $::env(IFV_HIER).ip_top_sva.lp_ctrl.bank*.assert_t1_padr_return_loop
assertion -show -all
prove
