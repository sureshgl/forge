...
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.rffb_loop*.rffh_loop*.*.assert_rdfifo_overflow_ifc_check
assertion -add $::env(IFV_HIER).ip_top_sva.wffb_loop*.wffh_loop*.*.assert_wrfifo_overflow_ifc_check
assertion -show -all
prove
