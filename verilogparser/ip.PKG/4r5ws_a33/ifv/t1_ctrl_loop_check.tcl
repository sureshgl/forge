...
constraint -show -all
assertion  -add $::env(IFV_HIER).ip_top_sva.hp_ctrl.bank*.assert_t1_ctrl_return_loop
#TBD padr is not looped back for t1 assertion  -add $::env(IFV_HIER).ip_top_sva.hp_ctrl.bank*.assert_t1_padr_return_loop
assertion -show -all
prove
