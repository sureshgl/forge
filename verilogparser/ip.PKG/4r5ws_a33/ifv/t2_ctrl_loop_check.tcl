...
constraint -show -all
assertion  -add $::env(IFV_HIER).ip_top_sva.lp_ctrl.bank*.assert_t2_ctrl_return_loop
assertion  -add $::env(IFV_HIER).ip_top_sva.lp_ctrl.bank*.assert_t2_padr_return_loop
assertion -show -all
prove
