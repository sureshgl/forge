...
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_xor_int_check
constraint -add $::env(IFV_HIER).ip_top_sva.assert_xor_data_check
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_xor_more_check
assertion -show -all
prove
