...
constraint -add $::env(IFV_HIER_2).ip_top_sva_2.assert_rd_range_check
constraint -add $::env(IFV_HIER_2).ip_top_sva_2.assert_wr_range_check
constraint -add $::env(IFV_HIER_2).ip_top_sva.*assert_mem_check
constraint -show -all
assertion -add $::env(IFV_HIER_2).ip_top_sva.*assert_dout_check
assertion -show -all
prove
