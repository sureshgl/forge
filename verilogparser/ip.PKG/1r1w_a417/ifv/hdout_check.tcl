...
constraint -add $::env(IFV_HIER).ip_top_sva_2.*.assert_pe_prt_range_check
constraint -add $::env(IFV_HIER).ip_top_sva_2.*.assert_pe_ptr_range_check
...
constraint -add $::env(IFV_HIER).ip_top_sva.assert_hp*ru_check
constraint -show -all
