...
constraint -add $::env(IFV_HIER_A6).ip_top_sva.*.assert_sdout_check
constraint -add $::env(IFV_HIER_A6).ip_top_sva.*.assert_cdout_check
constraint -add $::env(IFV_HIER_A6).ip_top_sva.*.assert_pdout_check
constraint -show -all
assertion -add $::env(IFV_HIER_A6).ip_top_sva.*.assert_r*_fwd_check
assertion -add $::env(IFV_HIER_A6).ip_top_sva.assert_wr*_fwd_check
assertion -show -all
prove
