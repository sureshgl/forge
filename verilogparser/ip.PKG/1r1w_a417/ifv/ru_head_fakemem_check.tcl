...
#cutpoint -add $::env(IFV_HIER_A6).core.*.r*dat_out
#cutpoint -add $::env(IFV_HIER_A6).ip_top_sva.wr_err
cutpoint -show -all
...
constraint -show -all
assertion -add $::env(IFV_HIER_A6).ip_top_sva.assert_fakemem_check
assertion -show -all
prove
