...
#constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_pedo_check
#constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_pect_check
#constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_next_check
