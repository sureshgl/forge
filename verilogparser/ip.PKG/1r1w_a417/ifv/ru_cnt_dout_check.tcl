...
#cutpoint -add $::env(IFV_HIER_A5).core.*.rcdat_out
#cutpoint -add $::env(IFV_HIER_A5).core.*.rpdat_out
#cutpoint -add $::env(IFV_HIER_A5).core.vdout_int
cutpoint -show -all
constraint -add -pin rst 0
...
constraint -add $::env(IFV_HIER).ip_top_sva_2.*.assert_pope_check
...
constraint -show -all
assertion -add $::env(IFV_HIER_A5).ip_top_sva.*.assert_dout_check
assertion -add $::env(IFV_HIER_A5).ip_top_sva.*.assert_fwrd_check
assertion -add $::env(IFV_HIER_A5).ip_top_sva.*.assert_derr_check
assertion -add $::env(IFV_HIER_A5).ip_top_sva.*.assert_padr_check
assertion -show -all
prove
