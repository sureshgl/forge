...
#cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit1_err
#cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit1_pos
#cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit2_err
#cutpoint -add $::env(IFV_HIER_2).ip_top_sva.dout_bit2_pos
