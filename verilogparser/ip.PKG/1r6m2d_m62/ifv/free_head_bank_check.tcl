...
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_sdout_range_bank_check
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_sdout_salloc_bank_check
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_free_head_bank_check
#assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_free_tail_check
#assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_free_diff_check
assertion -show -all
prove
