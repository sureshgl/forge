...
constraint -add $::env(IFV_HIER).ip_top_sva.*.assert_rd_freecnt_check
constraint -show -all
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_new_enq_check
assertion -add $::env(IFV_HIER).ip_top_sva.*.assert_new_bank_check
assertion -add $::env(IFV_HIER).ip_top_sva.assert_new_same_check
assertion -show -all
prove
