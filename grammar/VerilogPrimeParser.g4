...
:  attribute_instance*  dot  ( port_identifier | string_literal ) (  lparen (  expression  )?  rparen  )? 
...
|  expression ESCAPEQUOTE LPAREN expression RPAREN  #expression_static_casting ;
matches_pattern
