...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.GeContext;
...
public class GeContextExt extends AbstractBaseExt {
	...
	public GeContext getContext() {
		return (GeContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof GeContext) {
				...
				throw new ClassCastException(
						ctx.getClass().getSimpleName() + " cannot be cased to " + GeContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
