...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.T10_path_delay_expressionContext;
...
public class T10_path_delay_expressionContextExt extends AbstractBaseExt {
	...
	@Override
	public T10_path_delay_expressionContext getContext() {
		return (T10_path_delay_expressionContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof T10_path_delay_expressionContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ T10_path_delay_expressionContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
