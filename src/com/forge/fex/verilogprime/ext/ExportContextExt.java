...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.ExportContext;
...
public class ExportContextExt extends AbstractBaseExt {
	...
	public ExportContext getContext() {
		return (ExportContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof ExportContext) {
				...
				throw new ClassCastException(
						ctx.getClass().getSimpleName() + " cannot be cased to " + ExportContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
