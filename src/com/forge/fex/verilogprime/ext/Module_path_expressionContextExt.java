...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Module_path_expressionContext;
...
public class Module_path_expressionContextExt extends AbstractBaseExt {
	...
	@Override
	public Module_path_expressionContext getContext() {
		return (Module_path_expressionContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Module_path_expressionContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Module_path_expressionContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
