...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Non_port_interface_itemContext;
...
public class Non_port_interface_itemContextExt extends AbstractBaseExt {
	...
	@Override
	public Non_port_interface_itemContext getContext() {
		return (Non_port_interface_itemContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Non_port_interface_itemContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Non_port_interface_itemContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
