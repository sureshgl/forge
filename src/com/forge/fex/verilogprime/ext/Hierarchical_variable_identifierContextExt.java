...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Hierarchical_variable_identifierContext;
...
public class Hierarchical_variable_identifierContextExt extends AbstractBaseExt {
	...
	@Override
	public Hierarchical_variable_identifierContext getContext() {
		return (Hierarchical_variable_identifierContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Hierarchical_variable_identifierContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Hierarchical_variable_identifierContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
