...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Package_declaration_part1Context;
...
public class Package_declaration_part1ContextExt extends AbstractBaseExt {
	...
	@Override
	public Package_declaration_part1Context getContext() {
		return (Package_declaration_part1Context) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Package_declaration_part1Context) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Package_declaration_part1Context.class.getName());
			}
		} else {
			addToContexts(null);
		}
