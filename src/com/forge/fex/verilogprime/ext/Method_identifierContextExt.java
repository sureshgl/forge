...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Method_identifierContext;
...
public class Method_identifierContextExt extends AbstractBaseExt {
	...
	@Override
	public Method_identifierContext getContext() {
		return (Method_identifierContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Method_identifierContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Method_identifierContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
