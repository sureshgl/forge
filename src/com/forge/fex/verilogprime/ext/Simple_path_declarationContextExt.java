...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Simple_path_declarationContext;
...
public class Simple_path_declarationContextExt extends AbstractBaseExt {
	...
	@Override
	public Simple_path_declarationContext getContext() {
		return (Simple_path_declarationContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Simple_path_declarationContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Simple_path_declarationContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
