...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Interface_port_declarationContext;
...
public class Interface_port_declarationContextExt extends AbstractBaseExt {
	...
	@Override
	public Interface_port_declarationContext getContext() {
		return (Interface_port_declarationContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Interface_port_declarationContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Interface_port_declarationContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
