...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Class_type_part1Context;
...
public class Class_type_part1ContextExt extends AbstractBaseExt {
	...
	@Override
	public Class_type_part1Context getContext() {
		return (Class_type_part1Context) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Class_type_part1Context) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Class_type_part1Context.class.getName());
			}
		} else {
			addToContexts(null);
		}
