...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Setuphold_timing_checkContext;
...
public class Setuphold_timing_checkContextExt extends AbstractBaseExt {
	...
	@Override
	public Setuphold_timing_checkContext getContext() {
		return (Setuphold_timing_checkContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Setuphold_timing_checkContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Setuphold_timing_checkContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
