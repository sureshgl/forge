...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Loop_variables_part1Context;
...
public class Loop_variables_part1ContextExt extends AbstractBaseExt {
	...
	@Override
	public Loop_variables_part1Context getContext() {
		return (Loop_variables_part1Context) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Loop_variables_part1Context) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Loop_variables_part1Context.class.getName());
			}
		} else {
			addToContexts(null);
		}
