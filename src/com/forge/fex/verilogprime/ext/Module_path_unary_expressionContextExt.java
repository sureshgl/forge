...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Module_path_unary_expressionContext;
...
public class Module_path_unary_expressionContextExt extends AbstractBaseExt {
	...
	@Override
	public Module_path_unary_expressionContext getContext() {
		return (Module_path_unary_expressionContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Module_path_unary_expressionContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Module_path_unary_expressionContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
