...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.N_input_gate_instanceContext;
...
public class N_input_gate_instanceContextExt extends AbstractBaseExt {
	...
	@Override
	public N_input_gate_instanceContext getContext() {
		return (N_input_gate_instanceContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof N_input_gate_instanceContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ N_input_gate_instanceContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
