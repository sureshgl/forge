...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Hierarchical_sequence_identifierContext;
...
public class Hierarchical_sequence_identifierContextExt extends AbstractBaseExt {
	...
	@Override
	public Hierarchical_sequence_identifierContext getContext() {
		return (Hierarchical_sequence_identifierContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Hierarchical_sequence_identifierContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Hierarchical_sequence_identifierContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
