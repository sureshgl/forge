...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Enum_name_declarationContext;
...
public class Enum_name_declarationContextExt extends AbstractBaseExt {
	...
	@Override
	public Enum_name_declarationContext getContext() {
		return (Enum_name_declarationContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Enum_name_declarationContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Enum_name_declarationContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
