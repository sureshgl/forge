...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.List_of_port_declarationsContext;
...
public class List_of_port_declarationsContextExt extends AbstractBaseExt {
	...
	@Override
	public List_of_port_declarationsContext getContext() {
		return (List_of_port_declarationsContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof List_of_port_declarationsContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ List_of_port_declarationsContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
