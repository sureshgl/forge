...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Trise_path_delay_expressionContext;
...
public class Trise_path_delay_expressionContextExt extends AbstractBaseExt {
	...
	@Override
	public Trise_path_delay_expressionContext getContext() {
		return (Trise_path_delay_expressionContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Trise_path_delay_expressionContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Trise_path_delay_expressionContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
