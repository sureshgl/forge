...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Ps_or_hierarchical_array_identifierContext;
...
public class Ps_or_hierarchical_array_identifierContextExt extends AbstractBaseExt {
	...
	@Override
	public Ps_or_hierarchical_array_identifierContext getContext() {
		return (Ps_or_hierarchical_array_identifierContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Ps_or_hierarchical_array_identifierContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Ps_or_hierarchical_array_identifierContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
