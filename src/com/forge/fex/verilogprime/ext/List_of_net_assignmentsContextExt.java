...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.List_of_net_assignmentsContext;
...
public class List_of_net_assignmentsContextExt extends AbstractBaseExt {
	...
	@Override
	public List_of_net_assignmentsContext getContext() {
		return (List_of_net_assignmentsContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof List_of_net_assignmentsContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ List_of_net_assignmentsContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
