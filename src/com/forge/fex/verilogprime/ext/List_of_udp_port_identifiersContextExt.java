...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.List_of_udp_port_identifiersContext;
...
public class List_of_udp_port_identifiersContextExt extends AbstractBaseExt {
	...
	@Override
	public List_of_udp_port_identifiersContext getContext() {
		return (List_of_udp_port_identifiersContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof List_of_udp_port_identifiersContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ List_of_udp_port_identifiersContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
