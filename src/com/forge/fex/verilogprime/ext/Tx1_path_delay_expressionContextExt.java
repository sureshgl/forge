...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Tx1_path_delay_expressionContext;
...
public class Tx1_path_delay_expressionContextExt extends AbstractBaseExt {
	...
	@Override
	public Tx1_path_delay_expressionContext getContext() {
		return (Tx1_path_delay_expressionContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Tx1_path_delay_expressionContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Tx1_path_delay_expressionContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
