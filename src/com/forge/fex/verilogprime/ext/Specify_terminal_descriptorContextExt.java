...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Specify_terminal_descriptorContext;
...
public class Specify_terminal_descriptorContextExt extends AbstractBaseExt {
	...
	@Override
	public Specify_terminal_descriptorContext getContext() {
		return (Specify_terminal_descriptorContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Specify_terminal_descriptorContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Specify_terminal_descriptorContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
