...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Assignment_pattern_keyContext;
...
public class Assignment_pattern_keyContextExt extends AbstractBaseExt {
	...
	@Override
	public Assignment_pattern_keyContext getContext() {
		return (Assignment_pattern_keyContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Assignment_pattern_keyContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Assignment_pattern_keyContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
