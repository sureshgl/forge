...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.Hierarchical_tf_identifierContext;
...
public class Hierarchical_tf_identifierContextExt extends AbstractBaseExt {
	...
	@Override
	public Hierarchical_tf_identifierContext getContext() {
		return (Hierarchical_tf_identifierContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof Hierarchical_tf_identifierContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ Hierarchical_tf_identifierContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
