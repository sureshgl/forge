...
import com.forge.fex.verilogprime.gen.VerilogPrimeParser.List_of_parameter_port_declarationContext;
...
public class List_of_parameter_port_declarationContextExt extends AbstractBaseExt {
	...
	@Override
	public List_of_parameter_port_declarationContext getContext() {
		return (List_of_parameter_port_declarationContext) contexts.get(contexts.size() - 1);
	}
		...
		if (ctx != null) {
			if (ctx instanceof List_of_parameter_port_declarationContext) {
				...
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "
						+ List_of_parameter_port_declarationContext.class.getName());
			}
		} else {
			addToContexts(null);
		}
